    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-900">Invite Publisher</h2>
        ...
        {inviteLink ? (
          <div>
            <p className="mb-3 text-sm text-slate-600">Invite created. Share this link with them:</p>
            <div className="mb-3 flex items-center gap-2 rounded-lg bg-slate-50 p-2 text-sm">
